...
sound\+\_\+control gets the source state of selected source and returns it state if a sound file is not playing and the motor\+\_\+velocity(movement) is != 0.\+0 then play a sound file. \hypertarget{classoctet_1_1vehicle_a8c833c3ae603e9ae1355a60fb10a43de}{\index{octet\+::vehicle@{octet\+::vehicle}!update@{update}}
