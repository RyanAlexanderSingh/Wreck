...
namespace octet {
  ...
  class wreck_game : public app {
    ...
    void makeCar(){
      ...
      world->addConstraint(hingeCA_1, false);

      //Axil to Wheel - Hinge 1
      btVector3 AWAxis(0.0f, 0.0f, 1.0f);
      btVector3 AW_1(0, 0, -0.3f);
      btHingeConstraint *hingeAW_1 = new btHingeConstraint((*axils[0]), (*wheels[0]), AW_1, btVector3(0.0f, 0.0f, 0.3f), AWAxis, AWAxis);
      ...
      world->addConstraint(hingeCA_2, false);

      //Axil to Wheel - Hinge 2
      btVector3 AW_2(0.0, 0, 0.3f);
      btHingeConstraint *hingeAW_2 = new btHingeConstraint((*axils[1]), (*wheels[1]), AW_2, btVector3(0, 0, -0.3f), AWAxis, AWAxis);
      ...
      btVector3 AW_3(0, 0, -0.3f);
      btHingeConstraint *hingeAW_3 = new btHingeConstraint((*axils[2]), (*wheels[2]), AW_3, btVector3(0.0f, 0.0f, 0.3f), AWAxis, AWAxis);
      ...
      btVector3 AW_4(0, 0, 0.3f);
      btHingeConstraint *hingeAW_4 = new btHingeConstraint((*axils[3]), (*wheels[3]), AW_2, btVector3(0.0f, 0.0f, -0.3f), AWAxis, AWAxis);
  ...
  public:
    ...
    void app_init() {
      ...
      add_car(modelToWorld, vec3(2.0f, 0.1f, 1.5f));
    ...
    void keyboardInputs(){
      ...
      if (is_key_down('D') || is_key_down(key_right)) {
        if (hinge_bottom_limit < (max_angle * 3.14159265f / 180.0f)){
          hinge_bottom_limit += step_angle * 3.14159265f / 180.0f;
          hinge_upper_limit += step_angle * 3.14159265f / 180.0f;
          rigid_bodies[1]->applyTorque(btVector3(40, 0, 0));
          hingeCA_1->setLimit(hinge_bottom_limit, hinge_upper_limit);
          hingeCA_2->setLimit(hinge_bottom_limit, hinge_upper_limit);
        }
      }
